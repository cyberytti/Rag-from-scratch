...
**DATA SOURCE:** [data_source](https://github.com/cyberytti/Rag-from-scratch/blob/main/step_1/data_source.txt)  
**DATA COLLECTOR CODE:** [data_collector.py](https://github.com/cyberytti/Rag-from-scratch/blob/main/step_1/data_collector.py) and [data_collector.go](https://github.com/cyberytti/Rag-from-scratch/blob/main/step_1/data_collector.go)

**DATA:** We are using ["The Adventures of Sherlock Holmes"](https://en.wikipedia.org/wiki/The_Adventures_of_Sherlock_Holmes) by Arthur Conan Doyle as our data.